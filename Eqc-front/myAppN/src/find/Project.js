                ...
                <View style={{
                ...
                }}>
                    {
                        ...
                        this.state.tits.map((item, key) => (
                            <View style={{ width: '90%', height: 150 * s,  backgroundColor:'#ff4500',flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2%' ,paddingLeft:'5%'}}>
                                ...
                                <TouchableOpacity style={{ width: '90%', }} onPress={() => Actions.detailproject({'projectid':item.projectid,'userid':this.state.userid})}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', height: 130 * s }}>
                                        <Text style={{ marginTop: 5 * s, width: '50%', height: 40 * s, fontSize: 25,color:'#fff' }}>{item.projectname}</Text>
                                        <Text style={{ marginTop: 15 * s, width: '20%',color:'#fff' }}>{item.personname}</Text>
                                        <Text style={{ marginTop: 15 * s, width: '30%',color:'#fff' }}>{item.companyname}</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        ))
