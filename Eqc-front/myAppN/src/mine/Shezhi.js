        ...
        return (
            <View>
                ...
                <View style={styles.view}>
                    <Text style={{fontSize:16,color:'#ff4500'}}>简介</Text>
                </View>
                <View style={styles.view}>
                    <Text style={{fontSize:16,color:'#ff4500'}}>法律声明及隐私权政策</Text>
                </View>
                <View style={styles.view}>
                    <Text style={{fontSize:16,color:'#ff4500'}}>版本更新</Text>
                </View>
                <View style={styles.view}>
                    <Text style={{fontSize:16,color:'#ff4500'}}>清除缓存</Text>
                </View>
                <View style={styles.view}>
                    <Text style={{fontSize:16,color:'#ff4500'}}>用户帮助</Text>
                </View>
                <View style={{marginTop:130,height:20,width:'50%',marginLeft:'25%'}}>
                    <Button onPress={()=>{AsyncStorage.removeItem('user');Actions.login()}} title="退出登录" color='#ff4500'></Button>
                </View>
            </View>
        )
    }
